...
export function RoadmapBackground() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-gradient-to-b from-indigo-500/5 via-purple-500/3 to-transparent blur-3xl dark:from-indigo-500/10 dark:via-purple-500/5" />
      ...
      {!prefersReducedMotion && (
        <>
          ...
          <motion.div
            ...
            className="absolute bottom-1/4 right-10 size-72 rounded-full bg-purple-400/5 blur-3xl dark:bg-purple-600/10"
          />
        </>
      )}
    </div>

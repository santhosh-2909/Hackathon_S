...
const DETAIL_STEPS: Record<'low' | 'medium' | 'high', number> = { low: 20, medium: 32, high: 48 };
const stepsFor = (detail: AcidSquaresProps['detail'] = 'medium'): number =>
...
const AcidSquares = ({
  ...
  return (
    <div ref={containerRef} className={`acid-squares-container ${className}`.trim()} />
  );
};
